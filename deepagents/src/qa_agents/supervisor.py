...
SPECIALISTS = [
    {
        ...
        "system_prompt": "Analyze the supplied assessment and documentation. Produce a requirements matrix with risks, assumptions, and coverage priorities.",
    },
    {
    ...
    },
    {
        ...
        "system_prompt": "Create positive, negative, and boundary API cases with request data, status assertions, response assertions, and cleanup requirements.",
    },
    {
        "name": "api_automation",
        "description": "Draft or review executable API automation.",
        "system_prompt": "Create maintainable pytest API automation with fixtures, parameterization, explicit assertions, and environment-based configuration. Do not invent unavailable endpoints.",
    },
    {
        "name": "ui_automation",
        "description": "Draft or review Playwright UI automation.",
        "system_prompt": "Create robust Playwright tests using accessible or stable selectors, explicit waits, assertions, cleanup, and at least one cross-functional Parts flow.",
    },
    {
...
Read the source before making assumptions. If a live target is unavailable, clearly label artifacts as drafts and list the required environment variables."""
